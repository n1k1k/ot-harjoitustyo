...
class GameView:
    ...
    def start(self):
        ...
        dealer_fr = LabelFrame(main_frame, text='Dealer', font=('Courier New', 12), bd=0, labelanchor='n')
        dealer_fr.pack(ipadx=20, pady=10)
        player_fr = LabelFrame(main_frame, text='Player', font=('Courier New', 12), bd=0, labelanchor='n')
        player_fr.pack(padx=20, ipadx=20)

        #Buttons
        button_fr = Frame(self.display, bg='plum1')
        button_fr.pack(pady=20)
        hit_button = Button(button_fr, text='Hit', font = ('Courier New', 14, 'bold'),command=self.player_hit)
        hit_button.grid(row=0,column=0)
        stand_button = Button(button_fr, text='Stad', font = ('Courier New', 14, 'bold'))
        stand_button.grid(row=0,column=1, padx = 20)
        new_game_button = Button(button_fr, text='New Game', font = ('Courier New', 14, 'bold'))
        ...
        if self.player_spot <= 5:
            if self.player_spot <= 1:
                if self.player_spot == 0:
                    ...
                    player_card_1 = Label(player_fr, text='')
                    ...
                    player_card_2 = Label(player_fr, text='')
                ...
                if self.player_spot == 2:
                    player_card_3 = Label(player_fr, text='')
                    ...
                    player_card_4 = Label(player_fr, text='')
                    ...
                    player_card_5 = Label(player_fr, text='')
        ...
        if self.dealer_spot <= 5:
            if self.dealer_spot <= 1:
                if self.dealer_spot == 0:
                    ...
                    dealer_card_1 = Label(dealer_fr, text='')
                    ...
                    dealer_card_2 = Label(dealer_fr, text='')
                ...
                if self.dealer_spot == 2:
                    dealer_card_3 = Label(dealer_fr, text='')
                    ...
                    dealer_card_4 = Label(dealer_fr, text='')
                    ...
                    dealer_card_5 = Label(dealer_fr, text='')
